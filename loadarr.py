...
def generate_dockercompose():
    ...
    # Media server choice
    media_server_choice = ""
    while media_server_choice not in ["y", "n"]:
    ...
    while usenet_client_choice not in ["y", "n"]:
    ...
    while downloader_choice not in ["y", "n"]:
        ...
        if downloader_choice == "y":
            while downloader_choice not in ["s", "r", "l", "d"]:
                ...
                downloader_choice = [choice for choice in downloader_choice if choice in ["s", "r", "l", "e"]]
    ...
    while extra_services_choice not in ["y", "n"]:
        ...
        if extra_services_choice == "y":
            extra_services_choice = input("Which extra services do you want to add? Separate with comma. [O]verseerr, "
                                          "[U]npackerr, [T]autulli: ").strip().lower()
            extra_services_choice = extra_services_choice.split(",")
            extra_services_choice = [choice for choice in extra_services_choice if choice in ["o", "u", "t"]]
    ...
    choices = {
        ...
        "extra_services": extra_services_choice
    }
    ...
    print(f"Extra services: {', '.join(choices['extra_services']) if choices['extra_services'] else 'None'}")
